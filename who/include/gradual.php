...
$nametime ='<div class=""><strong class="primary-font">'.$name.'</strong> <small class="pull-right text-muted">
<span class="glyphicon glyphicon-time"></span>'.$usedt .'</small></div>';
