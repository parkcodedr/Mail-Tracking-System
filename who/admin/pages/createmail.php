          ...
          Fill in the Admin details below.
            ...
            <div class="panel-body">
              ...
              <form method="POST" id="adminadd">
                ...
                <input type="hidden" class="form-control" id="real" name="realad" >
                <div class="form-group">
                  <label for="name" class="form-label">Name Of New Admin </label>
                  <input type="text" class="form-control" id="name" name="name">
                </div>

                <div class="form-group">
                  <label for="email" class="form-label">Email of New Admin</label>
                  <input type="text" class="form-control" id="email" name="email">
                </div>

                 <div class="form-group">
                  <label for="phone" class="form-label">Phone Number of New Admin</label>
                  <input type="text" class="form-control" id="phone" name="phone">
                </div>

                <div class="form-group">
                  <label for="office" class="form-label">Office of New Admin</label>
                 ...
                 <div class="form-group">
                  <label for="password" class="form-label">Password of New Admin</label>
                  <input type="text" class="form-control" id="password" name="password">
                </div>


                <p><textarea class="textarea form-control wysihtml5-textarea" placeholder="Job Description Of Admin"  style="height:200px; width:100%;" name="description"  id="description"></textarea></p>
...
$("#enter").click(function (event){
   ...
   if (name=="" || name.length < 1 || !letters.test(name)) {
          ...
          $('#phone')[0].focus();
            ...
            $('#error').html(errorme(" Sorry your Admin Description is empty ") );
            $('#description')[0].focus();

     }else{
        //alert(real);
        var details = $('#adminadd').serialize();
        $.ajax({
