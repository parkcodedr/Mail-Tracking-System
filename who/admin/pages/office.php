    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-title"> 
          Fill in the Office details below.
        </div>

            <div class="panel-body">

              <form method="POST" id="officeadd">

                <input type="hidden" class="form-control" id="realoffice" name="realoffice" >
                <div class="form-group">
                  <label for="input1" class="form-label">Name Of office </label>
                ...
                <p><textarea class="textarea form-control wysihtml5-textarea" id="description" placeholder="Short Description Of Office"  style="height:200px; width:100%;"></textarea></p>
...
$("#enter").click(function (event){
   ...
   if (name=="" || name.length < 1 ) {
            ...
            $('#error').html(errorme(" Sorry your Office Description is empty ") );
            $('#description')[0].focus();

     }else{
        //alert(real);
        var details = $('#officeadd').serialize();
        $.ajax({
       ...
       // timeout: 2000,                                           // Waiting time
        ...
        success: function(data) {
          var me = data;
          if (me == 'great') {
          document.getElementById("officeadd").reset();
