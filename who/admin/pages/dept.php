        ...
        <div class="panel-title"> 
          Fill in the Department details below.
            ...
            <div class="panel-body">
              ...
              <form method="POST" id="deptaddform">

                <input type="hidden" class="form-control"  name="deptadd" id="deptadd" >

                <div class="form-group">
                  <label for="input1" class="form-label">Name Of Department </label>
                  <input type="text" class="form-control" id="name" name="name">
                </div>

                <div class="form-group">
                  <label for="input1" class="form-label">Name Of Head Faculty </label>
                ...
                <p><textarea class="textarea form-control wysihtml5-textarea" placeholder="Short Description Of Department"  style="height:200px; width:100%; " id="description"></textarea></p>
...
$("#enter").click(function (event){
   ...
   if (name=="" || name.length < 1 ) {
            ...
            $('#error').html(errorme(" Sorry your Department Description is empty ") );
            $('#description')[0].focus();

     }else{
        //alert(real);
        var details = $('#deptaddform').serialize();
        $.ajax({
       ...
       // timeout: 2000,                                           // Waiting time
        ...
        success: function(data) {
          var me = data;
          if (me == 'great') {
          document.getElementById("deptaddform").reset();
